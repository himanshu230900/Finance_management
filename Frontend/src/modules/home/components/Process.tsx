  ...
  return (
    <div className='flex flex-col items-center justify-center w-full bg-slate-50 rounded-xl p-5 xl:py-8 xl:px-8'>
      ...
      <div className='flex flex-col items-center justify-center'>
        <p className='font-medium text-lg py-4'>Process</p>
        <p className='font-bold text-3xl lg:text-5xl pt-1 xl:pt-3'>Automate Your Portfolio Management</p>
        <p className='font-bold text-3xl lg:text-5xl'>Smarter, Faster, Better</p>  
      </div>
       {/* Cards  */}
